...
export function NewQuestionTemplateCard() {
  ...
  return (
    <div
      className="flex h-24 w-52 cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-4 border-white bg-green-500 text-white shadow-2xl transition hover:scale-95 active:scale-90"
