...
export default function UserHome() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between bg-slate-200 text-slate-950">
      <UserCardAction user={user} onClick={handleBackToMenu} />
      ...
      <div className="m-4 flex h-16 w-72 items-center justify-around gap-4 rounded-md border-4 border-white bg-yellow-500 p-4 font-bold text-white shadow-2xl">
