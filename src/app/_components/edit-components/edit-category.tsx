      ...
      >
        ...
        <div className="my-2 flex flex-wrap justify-center gap-1">
          <button
            ...
            className="h-6 w-6 rounded-md border border-white bg-red-500"
          ></button>
          <button
            onClick={() => setColor("orange-500")}
            className="h-6 w-6 rounded-md border border-white bg-orange-500"
          ></button>
          <button
            onClick={() => setColor("amber-500")}
            className="h-6 w-6 rounded-md border border-white bg-amber-500"
          ></button>
          <button
            onClick={() => setColor("yellow-500")}
            className="h-6 w-6 rounded-md border border-white bg-yellow-500"
          ></button>
          <button
            onClick={() => setColor("lime-500")}
            className="h-6 w-6 rounded-md border border-white bg-lime-500"
          ></button>
          <button
            onClick={() => setColor("green-500")}
            className="h-6 w-6 rounded-md border border-white bg-green-500"
          ></button>
          <button
            onClick={() => setColor("emerald-500")}
            className="h-6 w-6 rounded-md border border-white bg-emerald-500"
          ></button>
          <button
            onClick={() => setColor("teal-500")}
            className="h-6 w-6 rounded-md border border-white bg-teal-500"
          ></button>
          <button
            onClick={() => setColor("cyan-500")}
            className="h-6 w-6 rounded-md border border-white bg-cyan-500"
          ></button>
          <button
            onClick={() => setColor("sky-500")}
            className="h-6 w-6 rounded-md border border-white bg-sky-500"
          ></button>
          <button
            onClick={() => setColor("blue-500")}
            className="h-6 w-6 rounded-md border border-white bg-blue-500"
          ></button>
          <button
            onClick={() => setColor("indigo-500")}
            className="h-6 w-6 rounded-md border border-white bg-indigo-500"
          ></button>
          <button
            onClick={() => setColor("violet-500")}
            className="h-6 w-6 rounded-md border border-white bg-violet-500"
          ></button>
          <button
            onClick={() => setColor("purple-500")}
            className="h-6 w-6 rounded-md border border-white bg-purple-500"
          ></button>
          <button
            onClick={() => setColor("fuchsia-500")}
            className="h-6 w-6 rounded-md border border-white bg-fuchsia-500"
          ></button>
          <button
            onClick={() => setColor("pink-500")}
            className="h-6 w-6 rounded-md border border-white bg-pink-500"
          ></button>
          <button
            onClick={() => setColor("rose-500")}
            className="h-6 w-6 rounded-md border border-white bg-rose-500"
          ></button>
          <button
            onClick={() => setColor("slate-500")}
            className="h-6 w-6 rounded-md border border-white bg-slate-500"
          ></button>
        </div>
        <button
          type="submit"
